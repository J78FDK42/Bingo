...
Use the bingo start screen using the `'b'` key
-OR-
...
Just extract and drop any or all datapacks into your save's datapacks folder and make sure custom advancements are enabled.
